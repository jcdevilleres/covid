...
colnames(covid_data_ts_latlong) <- c(colnames(covid_data_ts_latlong)[1:4],
  str_c('D1: ', str_pad(as.character(1:n_times), 2, 'left', '0'),
...
ggplot(legend = FALSE) +
  ...
  geom_polygon(data = world, aes(x = long, y = lat, group = group),
               color = 'black', fill = 'antiquewhite') +  xlab('') + ylab('') + 
  ...
  scale_size_continuous(range = c(0, 30)) + ggtitle('Occurrences Map - COVID19') +
